      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-surface-500 dark:text-surface-400 max-w-xs leading-relaxed">
              {t('footer.description', 'Empowering the next generation with modern, professional tools to build the future.')}
            </p>
            <div className="flex gap-4 pt-2">
              <a href="#" className="text-surface-400 hover:text-primary-500 transition-colors" aria-label="Twitter">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
              </a>
              <a href="#" className="text-surface-400 hover:text-primary-500 transition-colors" aria-label="GitHub">
              ...
              <a href="#" className="text-surface-400 hover:text-primary-500 transition-colors" aria-label="LinkedIn">
        ...
        <div className="pt-8 border-t border-surface-200 dark:border-surface-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-surface-500 dark:text-surface-400">
            {t('footer.copyright', '© 2024 Tools4Genz. All rights reserved.', { year: new Date().getFullYear() })}
          </p>
        </div>
      </Container>
    </footer>
